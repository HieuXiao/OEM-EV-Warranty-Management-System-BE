...
public class WarrantyClaimManagerController {
    ...
    // Gán EVM sau khi đã có thành phần
    @PostMapping("/{claimId}/assign-evm/{evmId}")
    public ResponseEntity<Void> assignEvm(@PathVariable int claimId, @PathVariable String evmId) {
