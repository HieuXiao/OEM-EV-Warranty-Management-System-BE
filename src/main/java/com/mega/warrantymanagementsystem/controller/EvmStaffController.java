...
public class EvmStaffController {
    ...
    @GetMapping("/random")
    public ResponseEntity<AccountResponse> getRandomEvmStaff() {
        AccountResponse randomStaff = evmStaffService.getRandomEvmStaff();
        return ResponseEntity.ok(randomStaff);
    }
